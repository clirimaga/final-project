        ...
        <div className="col-4">
          <div className="card">
            <div className="card-body text-center">
              ...
              <ul className='dots'>
             <li><a href='https://open.spotify.com/album/1hIrsbY7DZ0ItN5OrPhI6a' className='linkStyle' target="_blank"> Hören und Verstehen
              </a></li>
             <li> <a href='https://www.youtube.com/watch?v=iUCSJBzhrv0'className='linkStyle'  target="_blank">Hören B1 Test</a></li>
             <li><a href='https://www.youtube.com/watch?v=WJzH_vK9e_Y'className='linkStyle'  target="_blank">B1 B2 C1</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div className="col-4">
          <div className="card">
            <div className="card-body text-center">
              ...
              <ul className='dots'>
              <li><a href='https://www.youtube.com/watch?v=6Ka_3Rq8JZ4' className='linkStyle'  target="_blank">A1 Complete</a></li>
              <li><a href='https://www.youtube.com/watch?v=trEa3ovyDYM'className='linkStyle'  target="_blank">A2 Complete</a></li>
              <li><a href='https://www.youtube.com/watch?v=Y_5jwBdOukk'className='linkStyle'  target="_blank">B1 Complete</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div className="col-4">
          <div className="card">
            <div className="card-body text-center">
              ...
              <ul className='dots'>
              <li><a href='https://www.hueber.de/media/36/GLT_2016_2017_small.pdf' className='linkStyle'  target="_blank">Hueber</a></li>
              <li><a href='https://www.google.de/books/edition/Mit_Erfolg_zu_telc_Deutsch_B1_+_Beruf/eWJzrgEACAAJ?hl=en' className='linkStyle'  target="_blank">B1+Beruf</a></li>
              <li><a href='https://www.google.de/books/edition/Prüfungstraining/QnuqpwAACAAJ?hl=en' className='linkStyle'  target="_blank">Prüfungstraining</a></li>
              </ul>
            </div>
          </div>
        </div>
